...
- Client components are the exception, not the rule — currently: `theme-toggle`, `navigation-list`, `input-group`, `separator`, `code-block-highlight`, `post-reactions`, `ai-elements/persona`, `ui/tooltip`, `webmcp-provider`.
