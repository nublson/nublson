 ...
 * visitor's reaction (identified by their anonymous session ID).
 */
 ...
 * Switching from like to dislike (or vice versa) overwrites the previous value.
 */
 ...
 * A no-op if the visitor has not reacted yet.
 */
